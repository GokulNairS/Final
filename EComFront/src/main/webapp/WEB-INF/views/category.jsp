...
<div class="container">
 <c:if test="${editMode}">
        ...
        <c:if test="${!editMode}">
        <c:set var="url" value="${contextRoot}/admin/categoryadd"></c:set>
        </c:if>
                                                        ...
                                                        <c:forEach items="${catlist}" var="c">
                                                                <tr>
                                                                        ...
                                                                        <td class="td-actions text-right">
                                                                                ...
                                                                                <a href="${contextRoot}/admin/editcategory?category_name=${c.category_Name}" rel="tooltip"
                                                                                        class="btn btn-success btn-link btn-just-icon btn-sm"
                                                                                        data-original-title="" title="">
                                                                                        <i class="material-icons">edit</i>
                                                                                </a>
                                                                                <a href="${contextRoot}/admin/deletecategory?category_name=${c.category_Name}" rel="tooltip"
