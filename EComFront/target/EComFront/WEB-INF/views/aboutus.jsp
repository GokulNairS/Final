...
.paddingTB60 {
   ...
   .image-aboutus-banner {
    background: linear-gradient(rgba(0,0,0,.7), rgba(0,0,0,.7)), url("https://image.shutterstock.com/z/stock-photo-grand-arena-sports-collage-soccer-basketball-hockey-baseball-american-football-1071593777.jpg");
   ...
   <div class="container">
    <div class="row">
        <div class="col-md-12">
         ...
         <p class="image-aboutus-para">Life is a sport, Make it count .</p>
       </div>
    </div>
</div>
</div>
		...
		<div class="col-md-4 footer-one">
		    ...
		    <p>Cras sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Cras sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</p>
               ...
               <a href="https://twitter.com/"><i id="social-tw" class="fa fa-twitter-square fa-3x social"></i></a>
	            ...
	            <a href="mailto:rishisanthosh23@gmail.com"><i id="social-em" class="fa fa-envelope-square fa-3x social"></i></a>
	        </div>	
		</div>
