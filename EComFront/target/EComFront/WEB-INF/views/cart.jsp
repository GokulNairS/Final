...
<div class="container">
	<c:if test="${empty(listCart)}">
		...
		<a href="viewallproduct" class="btn button"><i
			...
			<tbody>
				<c:forEach items="${listCart}" var="l">
					<tr>
						<td data-th="Product">
							<div class="row">
								<div class="col-sm-4 hidden-xs">
									<img src="${l.pid}.jpg" alt="..." class="img-responsive" />
								</div>
								<div class="col-sm-8">
									<h4 class="nomargin" style="padding-top: 50px;">${l.pname}</h4>
								</div>
							</div>
						</td>
						...
						<td data-th="Subtotal" class="text-center">${l.subTot}</td>
						<td class="actions" data-th=""><a
							href="user/deleteitem?itemid=${l.itemid}"
