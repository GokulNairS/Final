...
#submitbtn, #resetbtn {
	...
	color: #ffffff;
	background: linear-gradient(to bottom, #f9b374 50%, #ffba7b 50%);
}
...
#submitbtn:hover, #resetbtn:hover, #paybutton:HOVER {
	background: linear-gradient(to bottom, #fcc99b 50%, #fcc99b 50%);
	color: #ffffff;
}
...
#holder {
	...
	border-radius: 5px;
	box-shadow: 2px 2px 20px #D72DAE;
	margin: 10px;
}
</style>
				...
				<form:form class="form-horizontal" method="post"
					...
					<div class="form-group">
						...
						<div class="controls">
							...
							<form:input class="form-control input-xlarge"
								placeholder="Enter Address Line 1" path="addL1" />

							<form:errors path="addL1" cssStyle="color:red"></form:errors>
					...
					<div class="form-group">
						...
						<div class="controls">
							...
							<form:input class="form-control input-xlarge"
								placeholder="Enter Address Line 2" path="addL2" />

							<form:errors path="addL2" cssStyle="color:red"></form:errors>
					...
					<div id="holder" class="col-sm-6 col-md-4">
						...
						<div id="bottom-block">
							...
							<div>
								...
								<a href="placeorder?addid=${al.addressid}" id="paybutton"
									class="btn" type="submit"> <i class="fa fa-truck"
									aria-hidden="true"></i> Deliver Here
