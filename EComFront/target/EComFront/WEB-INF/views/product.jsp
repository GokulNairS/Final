	...
	<div class="container">
		...
		<div class="login-form">
			...
			<div class="main-div">
				...
				<form:form enctype="multipart/form-data" modelAttribute="product" action="${url}" method="post">

						<c:if test="${editMode}">
							<div class="form-group">
								<form:input type="text" class="form-control" id="inputproductName" placeholder="" path="productId" readonly="true" />
							</div>
						</c:if>
						...
						<div class="form-group">
							...
							<form:input type="text" class="form-control"
								id="inputProductName" placeholder="Product Description"
								path="productDesc" />
						</div>
